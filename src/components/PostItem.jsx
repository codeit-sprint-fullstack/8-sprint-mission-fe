...
export default function PostItem({ item }) {
  ...
  return (
    <div className="flex flex-col gap-[16px] border-b pb-6 hover:shadow-md transition-shadow cursor-pointer" style={{borderColor: 'var(--gray-200)', backgroundColor: '#fcfcfc'}}>
