...
export default function SearchAndSort({ searchTerm, setSearchTerm, sortBy, setSortBy }) {
  return (
    <div className="flex flex-col sm:flex-row gap-4 mb-6">
      <div className="flex-1 relative">
        ...
        <input
          ...
          style={{backgroundColor: 'var(--gray-100)', focusRingColor: 'var(--primary-100)'}}
        />
      </div>
      <div className="relative">
        <select
          ...
          style={{borderColor: 'var(--gray-200)', focusRingColor: 'var(--primary-100)'}}
        >
        ...
        <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
          <Image 
            src="/images/icon/ic_arrow_down.svg" 
            alt="Arrow Down" 
            width={16} 
            height={16} 
          />
