...
//새로 만든 비밀번호 표시/끄기 눈 버튼 (브라우저에서 지원하는 기능은 끔)
const pwEye = document.querySelector('.pw-form a');
const repwEye = document.querySelector('.repw-form a');

pwEye?.addEventListener('click', () => pwToggle(pwInput));
repwEye?.addEventListener('click', () => pwToggle(repwInput));
...
const popupMeassage = document.querySelector('.popup h1');
...
function openPopup(message){
    popupMeassage.textContent = message;
